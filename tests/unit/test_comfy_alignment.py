...
class TestComfyAlignment(unittest.TestCase):
    def test_registry_has_builtin_components(self):
        ...
        self.assertIn("ltx2", list_adapters())
        ...
        self.assertIn("int8_tensorwise", registry.list_algorithms())
        ...
        self.assertIn("int8_tensorwise", registry.list_formats())
    ...
    def test_comfyui_contract_index_is_static_artifact_metadata(self):
        ...
        self.assertIn("ltx2", contracts["contracts"])
        # deliberate: ComfyUI-side layout is image_model="ltxav", not the family key
        self.assertEqual(contracts["contracts"]["ltx2"]["consumer_layout"], "ComfyUI ltxav")
