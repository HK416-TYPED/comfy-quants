"""Stock-ComfyUI INT8 (int8_tensorwise) quantization planner.
...
(``backends/int8_tensorwise_model_export.py``), bit-faithful to comfy-kitchen's
division-based ``quantize_int8_rowwise``.
"""
...
registry.register_algorithm(Int8TensorwiseAlgorithm())
